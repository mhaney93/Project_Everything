...
const TOPIC_KEYWORDS = {
  'Philosophy': ['metaphysic', 'epistem', 'ethics', 'logic', 'ontology', 'kant', 'plato', 'aristotle', 'descartes', 'hume', 'locke', 'spinoza', 'nietzsche', 'wittgenstein', 'phenomenology', 'hermeneutic'],
  'Metaphysics': ['being', 'substance', 'exist', 'reality', 'essence', 'modal', 'necessity', 'abstract', 'universal'],
  'Epistemology': ['knowledge', 'justify', 'belief', 'truth', 'reason', 'empiric', 'rational', 'induction', 'deduction', 'skeptic'],
  'Ethics': ['moral', 'virtue', 'value', 'right', 'wrong', 'good', 'duty', 'consequent', 'utilit', 'deontolog'],
  'Aesthetics': ['beauty', 'art', 'taste', 'sublime', 'aesthetic', 'judgment', 'form', 'expression', 'creative'],
  ...
  'Biology': ['organism', 'genetic', 'cell', 'evolution', 'species', 'anatomy', 'physiology', 'reproductive', 'penis', 'vagina', 'breast', 'uterus', 'ovary', 'testis', 'dna', 'protein', 'enzyme', 'metabolism', 'photosynthesis', 'biodiversity', 'ecology', 'mutation', 'blood', 'heart', 'lung', 'kidney', 'liver', 'brain', 'nerve', 'muscle', 'bone', 'tissue'],
  ...
  'Astronomy': ['space', 'star', 'planet', 'galaxy', 'cosmic', 'universe', 'asteroid', 'satellite', 'nebula', 'black hole', 'constellation', 'orbit', 'celestial', 'meteor'],
  'Earth Science': ['geology', 'earth', 'weather', 'climate', 'mineral', 'rock', 'plate tectonics', 'volcano', 'earthquake', 'erosion', 'atmosphere', 'ocean', 'soil'],
  
  'History': ['ancient', 'medieval', 'modern', 'era', 'period', 'century', 'war', 'civilization', 'revolution', 'empire', 'dynasty', 'renaissance', 'industrial', 'historical'],
  'Religious Studies': ['religion', 'theology', 'faith', 'spiritual', 'church', 'prayer', 'sermon', 'scripture', 'god', 'divine', 'sacred', 'ritual', 'worship', 'doctrine', 'belief system'],
  'Western Religions': ['christianity', 'judaism', 'islam', 'church', 'torah', 'quran', 'theology', 'monotheistic'],
  'Eastern Religions': ['buddhism', 'hinduism', 'taoism', 'confucian', 'zen', 'karma', 'dharma', 'meditation', 'enlightenment'],
  'Christianity': ['jesus', 'christ', 'gospel', 'church', 'trinity', 'salvation', 'cross', 'theology', 'sacrament'],
  'Islam': ['allah', 'muhammad', 'quran', 'mosque', 'jihad', 'shariah', 'five pillar', 'sunni', 'shia'],
  'Buddhism': ['buddha', 'enlightenment', 'dharma', 'karma', 'meditation', 'nirvana', 'bodhisattva', 'zen', 'tibetan'],
  
  'Psychology': ['mind', 'behavior', 'conscious', 'mental', 'cognitive', 'freud', 'brain', 'emotion', 'therapy', 'psyche', 'conditioning', 'perception', 'memory', 'development', 'personality', 'disorder'],
  'Neuroscience': ['brain', 'neural', 'cognitive', 'synapse', 'neuron', 'neurological', 'behavioral', 'cortex', 'cerebral'],
  'Sociology': ['society', 'social', 'culture', 'community', 'group', 'institution', 'class', 'identity', 'network', 'conflict', 'structure', 'norm'],
  'Anthropology': ['culture', 'human', 'society', 'ritual', 'kinship', 'ethnography', 'tribe', 'social structure', 'evolutionary'],
  'Economics': ['market', 'trade', 'money', 'economy', 'business', 'price', 'supply', 'demand', 'investment', 'capital', 'labor', 'inflation', 'gdp', 'commerce'],
  
  'Arts': ['art', 'visual', 'painting', 'sculpture', 'gallery', 'creative', 'aesthetic', 'design', 'craft', 'medium', 'composition', 'perspective'],
  'Visual Arts': ['painting', 'sculpture', 'drawing', 'graphics', 'color', 'form', 'perspective', 'composition', 'architecture'],
  'Performing Arts': ['theater', 'dance', 'performance', 'acting', 'stage', 'drama', 'script', 'choreography'],
  'Music': ['musical', 'song', 'melody', 'harmony', 'composition', 'instrument', 'audio', 'rhythm', 'note', 'scale', 'tempo', 'orchestra', 'concert'],
  'Literature': ['novel', 'poetry', 'writing', 'author', 'story', 'narrative', 'character', 'plot', 'fiction', 'prose', 'verse', 'metaphor'],
  'Languages': ['language', 'linguistic', 'grammar', 'syntax', 'translation', 'dialect', 'communication', 'phonetic', 'semantic', 'etymology', 'vocabulary'],
  'Statistics': ['data', 'probability', 'distribution', 'variance', 'mean', 'regression', 'sampling', 'hypothesis', 'correlation'],
}
